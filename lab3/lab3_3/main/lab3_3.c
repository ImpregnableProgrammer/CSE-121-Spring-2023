...
// Task method for sending mouse movement over bluetooth
// Uses accelerometer rather than gyroscope since gyroscope data is messy and requires integration over time, which drifts
void hid_bluetooth_mouse_task(void *pvParameters)
{
...
void app_main(void)
{
    ...
    /* If your BLE device act as a Slave, the init_key means you hope which types of key of the master should
 distribute to you,
    and the response key means which key you can distribute to the Master;
    If your BLE device act as a master, the response key means you hope which types of key of the slave shoul
d distribute to you,
    ...
    i2c_master_init();
    xTaskCreate(&hid_bluetooth_mouse_task, "bluetooth_mouse_task", 2048, NULL, 5, NULL);
}
